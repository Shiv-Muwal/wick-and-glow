...
export const initialAdminState = {
  ...
  orders: [
    { id: '#ORD-001', customer: 'Priya Sharma', product: 'Rose Aroma Candle', amount: 1798, status: 'delivered', date: '2024-01-15', pincode: '400050', payment: 'cod' },
    { id: '#ORD-002', customer: 'Rohit Verma', product: 'Sandalwood Bliss', amount: 1199, status: 'shipped', date: '2024-01-16', pincode: '110001', payment: 'cod' },
    { id: '#ORD-003', customer: 'Ananya Gupta', product: 'Lavender Dreams', amount: 849, status: 'pending', date: '2024-01-17', pincode: '560001', payment: 'cod' },
    { id: '#ORD-004', customer: 'Karan Malhotra', product: 'Oud Royale', amount: 3198, status: 'delivered', date: '2024-01-14', pincode: '400001', payment: 'cod' },
    { id: '#ORD-005', customer: 'Nidhi Patel', product: 'Citrus Sunrise', amount: 1498, status: 'cancelled', date: '2024-01-13', pincode: '700001', payment: 'cod' },
    { id: '#ORD-006', customer: 'Arjun Singh', product: 'Coconut Paradise', amount: 699, status: 'shipped', date: '2024-01-17', pincode: '411001', payment: 'cod' },
    { id: '#ORD-007', customer: 'Simran Kaur', product: 'Rose Aroma Candle', amount: 899, status: 'pending', date: '2024-01-18', pincode: '400052', payment: 'cod' },
  ],
  customers: [
